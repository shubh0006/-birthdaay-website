...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    /* ========= Header / greeting ========= */
    header { text-align:center; position:relative; padding-top:24px; }
    h1 { font-size:2.6rem; margin:10px 0; color:#5c0b46; letter-spacing:0.5px; }
    p.lead { margin:0 0 12px 0; color:#6b2a4a; font-size:1.05rem; }

    /* Play music button */
    .controls { display:flex; gap:12px; justify-content:center; margin:12px 0 24px; }
    .btn {
      background:#ff6f91; color:white; border:none; padding:10px 16px; border-radius:999px;
      cursor:pointer; font-weight:600; box-shadow:0 6px 18px rgba(0,0,0,0.12);
    }
    .btn.secondary { background:#ffd166; color:#3b2f2f; }

    /* ========= Balloons ========= */
    .balloon {
      width:64px; height:86px; position:absolute; bottom:-200px;
    ...
    .balloon::after {
      ...
      width:2px; height:24px; background:rgba(0,0,0,0.12);
    }
    .b1 { left:6%; background:#ff6f91; animation-duration:8s; animation-delay:0s; }
    .b2 { left:26%; background:#ff9671; animation-duration:9s; animation-delay:1s; }
    .b3 { left:50%; background:#ffc75f; animation-duration:10s; animation-delay:0.5s; }
    .b4 { left:74%; background:#7bed9f; animation-duration:11s; animation-delay:0.9s; }
    @keyframes floatUp {
      0% { transform:translateY(0) rotate(-4deg); opacity:1; }
      50% { transform:translateY(-10vh) rotate(4deg); opacity:0.95; }
  ...
  <div class="container">
    ...
    <section class="slideshow">
      ...
      <div class="slides" id="slides">
        <img src="shivu1.jpg" alt="Sister photo 1" id="currentSlide">
    ...
    <section class="timeline">
      ...
      <div class="time-item">
        <img src="shivu1.jpg" alt="School memory">
        <div class="meta">
          <h4>Fun & Playful</h4>
      ...
      <div class="time-item">
        <img src="shivu3.jpg" alt="Family memory">
        <div class="meta">
          <h4>Short & Cute:</h4>
